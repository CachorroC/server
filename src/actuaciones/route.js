...
exports.getActuaciones = exports.fetchActuaciones = void 0;
const fsp = __importStar(require("fs/promises"));
const fsnp = __importStar(require("fs"));
process.env["NODE_TLS_REJECT_UNAUTHORIZED"] = "0";
const ConsultasNumeroRadicacion = [
    {
        ...
        procesos: [
            {
                ...
                despacho: "JUZGADO 007 CIVIL MUNICIPAL DE EJECUCIÓN DE SENTENCIAS DE BOGOTÁ ",
                departamento: "BOGOTÁ",
                sujetosProcesales: "Demandante: BANCOLOMBIA S.A. | Demandado: JOSÉ ANTONIO MONTEALEGRE HERNÁNDEZ | Demandado: YULY MARCELA PEÑA GARCIA ",
                esPrivado: false,
                cantFilas: -1,
            },
        ],
...
async function fetchActuaciones(idProceso) {
    const res = await fetch(`https://consultaprocesos.ramajudicial.gov.co:448/api/v2/Proceso/Actuaciones/${idProceso}`);
    console.log("res: " + res);
    ...
    if (fsnp.existsSync(`actuaciones/${idProceso}`)) {
        ...
        fsp.appendFile(`actuaciones/${idProceso}/actuaciones.json`, actuacionesRaw);
    }
    else {
...
async function getActuaciones() {
    const res = ConsultasNumeroRadicacion.forEach((radicado, index) => {
        ...
        setTimeout(() => {
            if (radicado.procesos.length === 0) {
                ...
                radicado.procesos.forEach((proceso, i) => {
...
exports.getActuaciones = getActuaciones;
